...
| --- | --- | --- |
| Glucose only | ~60 g/hr | [Jeukendrup, 2004](https://pubmed.ncbi.nlm.nih.gov/15212750/) |
| Glucose + Fructose | 90-105 g/hr | [Jentjens & Jeukendrup, 2005](https://pubmed.ncbi.nlm.nih.gov/15877900/) |
| Trained gut + optimal ratio | Up to 120 g/hr | [Hearris et al., 2022](https://pubmed.ncbi.nlm.nih.gov/35514294/) |

This is why most sports nutrition products now use glucose:fructose blends (often listed as maltodextrin + fructose). The research from Jentjens & Jeukendrup (2005) showed that athletes can oxidize up to **105 g/hr** with the right carb mix — representing a 75% increase over single-source carbohydrate ([Jentjens & Jeukendrup, 2005, *British Journal of Nutrition*](https://pubmed.ncbi.nlm.nih.gov/15877900/)).

More recent work has pushed this further. Hearris and colleagues (2022) demonstrated that **120 g/hr is practically tolerable** for athletes with trained guts using an optimized 1:0.8 glucose:fructose ratio ([Hearris et al., 2022](https://pubmed.ncbi.nlm.nih.gov/35514294/)).

### The Optimal Carbohydrate Ratio

Not all glucose:fructose ratios are equal. The research has evolved:

- **2:1 ratio (glucose:fructose):** Optimal for intakes up to 90 g/hr ([Jeukendrup, 2008, *European Journal of Sport Science*](https://www.tandfonline.com/doi/full/10.1080/17461390801918971))
- **1:0.8 ratio:** Better for intakes of 90-120 g/hr, with improved GI comfort ([Rowlands et al., 2015](https://pubmed.ncbi.nlm.nih.gov/25202917/))
...
We use duration and intensity as the primary drivers, following the evidence-based guidelines from the American College of Sports Medicine and International Olympic Committee consensus statements ([Thomas et al., 2016, *Journal of the Academy of Nutrition and Dietetics*](https://pubmed.ncbi.nlm.nih.gov/26920240/)):

**Base Recommendations by Duration:**

| Workout Duration | Carb Target | Scientific Rationale |
| --- | --- | --- |
| Under 60 min | 0-30 g total | Glycogen stores sufficient; mouth rinse approach may help ([Carter et al., 2004](https://pubmed.ncbi.nlm.nih.gov/15570150/)) |
| 60-90 min | 30-60 g/hr | Maintains blood glucose ([Burke et al., 2011](https://pubmed.ncbi.nlm.nih.gov/21916794/)) |
| 90 min - 2.5 hr | 45-60 g/hr | Delays glycogen depletion |
| 2.5 - 4 hr | 60-90 g/hr | Requires multiple transportable carbs ([Jeukendrup, 2014](https://pubmed.ncbi.nlm.nih.gov/24791914/)) |
| 4+ hr | 80-100+ g/hr | Maximum sustainable; must include real food ([Pfeiffer et al., 2012](https://pubmed.ncbi.nlm.nih.gov/21775906/)) |

*Sources: [Burke et al., 2011, Journal of Sports Sciences](https://pubmed.ncbi.nlm.nih.gov/21916794/); [Jeukendrup, 2014, Sports Medicine](https://pubmed.ncbi.nlm.nih.gov/24791914/); [Thomas et al., 2016](https://pubmed.ncbi.nlm.nih.gov/26920240/)*
...
1. **Top off liver glycogen** — Depleted overnight, liver glycogen fuels your brain and maintains blood glucose ([Casey et al., 2000](https://pubmed.ncbi.nlm.nih.gov/10919968/))
2. **Ensure adequate muscle glycogen** — Your primary fuel for moderate-to-high intensity work ([Hawley & Burke, 2010](https://pubmed.ncbi.nlm.nih.gov/20616742/))
3. **Optimize hydration status** — Start euhydrated, not playing catch-up ([Sawka et al., 2007](https://pubmed.ncbi.nlm.nih.gov/17277604/))
...
Research has established clear timing-based guidelines. The closer you get to your workout, the simpler and smaller your nutrition should be ([Kerksick et al., 2017, *Journal of the International Society of Sports Nutrition*](https://pubmed.ncbi.nlm.nih.gov/28919842/)).

**3-4 Hours Before: The Full Meal Window**

| Nutrient | Target | Rationale |
| --- | --- | --- |
| Carbohydrate | 1-4 g/kg body weight | Tops off glycogen stores ([Burke et al., 2011](https://pubmed.ncbi.nlm.nih.gov/21916794/)) |
| Protein | 0.15-0.25 g/kg | Supports muscle protein balance ([Kerksick et al., 2017](https://pubmed.ncbi.nlm.nih.gov/28919842/)) |
...
| Nutrient | Target | Rationale |
| --- | --- | --- |
| Carbohydrate | 1-2 g/kg body weight | Maintain blood glucose ([Ormsbee et al., 2014](https://pubmed.ncbi.nlm.nih.gov/25028999/)) |
| Protein | 0-10g | Optional; keep minimal |
| Fat | <10g | Slows gastric emptying; minimize ([Rehrer et al., 1992](https://pubmed.ncbi.nlm.nih.gov/1386594/)) |
...
| Nutrient | Target | Rationale |
| --- | --- | --- |
| Carbohydrate | 0.5-1 g/kg | Final glucose availability boost ([Jeukendrup & Killer, 2010](https://pubmed.ncbi.nlm.nih.gov/21116024/)) |
...
This window is for simple, fast-digesting carbs only — a gel, sports drink, white bread with honey, or a ripe banana. Research shows that consuming carbohydrate in this window can enhance performance, particularly for sessions starting with low glycogen or lasting >60 minutes ([Jeukendrup & Killer, 2010, *Annals of Nutrition and Metabolism*](https://pubmed.ncbi.nlm.nih.gov/21116024/)).
...
- Reduced splanchnic (gut) blood flow — up to 80% reduction at maximal exercise ([van Wijck et al., 2012](https://pubmed.ncbi.nlm.nih.gov/22253445/))
- Slower gastric emptying
- Increased GI symptom risk

A systematic review found that *"exercise intensity is considered one of the most important factors determining gastrointestinal disturbance during exercise"* ([de Oliveira et al., 2014, *Sports Medicine*](https://pubmed.ncbi.nlm.nih.gov/24619104/)).
...
A 2016 meta-analysis found that aerobic exercise performed fasted induces significantly higher fat oxidation than exercise performed fed ([Vieira et al., 2016, *British Journal of Nutrition*](https://pubmed.ncbi.nlm.nih.gov/27609363/)). The mechanism: without incoming carbohydrate, insulin levels remain low, allowing greater mobilization of fatty acids for fuel.

Research from Van Proeyen et al. (2011) demonstrated that 6 weeks of fasted training enhanced markers of fat metabolism, including increased fatty acid binding protein (FABPm) content and reduced glycogen breakdown during exercise ([Van Proeyen et al., 2011](https://pubmed.ncbi.nlm.nih.gov/20837645/)).

However, there's a critical caveat from Dr. Daniel Moore's research at the University of Toronto: **training with low carbohydrate availability increases protein requirements**. In a carefully controlled study, Gillen, Moore and colleagues found that endurance exercise performed in a low-carbohydrate state resulted in significantly higher amino acid oxidation during recovery, suggesting a greater protein requirement to support whole-body protein synthesis ([Gillen et al., 2019, *Medicine & Science in Sports & Exercise*](https://pubmed.ncbi.nlm.nih.gov/31107837/)).
...
A comprehensive review concluded: *"We recommend that endurance athletes should avoid high intensity training while fasting"* ([Alghannam et al., 2020, *Open Access Journal of Sports Medicine*](https://pubmed.ncbi.nlm.nih.gov/31998064/)).
...
*The Protocol:*
1. **Evening:** Perform a high-intensity session (intervals, tempo) with full carb availability
2. **Post-workout:** Skip or minimize carbs until the next morning (extend the low-glycogen window)
3. **Morning:** Perform an easy/moderate session fasted (muscle glycogen already depleted from evening)
4. **Post-morning session:** Resume normal carbohydrate intake

Marquet et al. (2016) found that trained triathletes using this "sleep low" strategy for 3 weeks improved 10-km running performance by 2.9%, improved cycling efficiency by 11.7%, and reduced body fat by 1.1% compared to athletes consuming the same total carbohydrates distributed evenly throughout the day ([Marquet et al., 2016, *Medicine & Science in Sports & Exercise*](https://pubmed.ncbi.nlm.nih.gov/26741119/)).
...
Notably, consuming ~20g of protein before/during a train-low session can preserve the metabolic benefits while protecting muscle protein synthesis ([Impey et al., 2016](https://pubmed.ncbi.nlm.nih.gov/27302770/)).

**Option 2: Strategic Small Feeding (Best of Both Worlds)**

If you want to avoid true fasted training but can't eat a full meal, research supports consuming a small amount of easily digestible carbohydrate (25-50g) 15-30 minutes before exercise ([Jeukendrup & Killer, 2010](https://pubmed.ncbi.nlm.nih.gov/21116024/)). This provides enough glucose to support quality work without requiring early wake-up.
...
1. A "fasted training" option for suitable easy sessions (with elevated post-workout protein)
2. A minimal "wake and go" option with simple carbs only
3. An evening-before carb emphasis to compensate for morning limitations
4. A recommendation on which protocol best fits the specific workout

### Pre-Workout Hydration and Sodium: Start Ahead

Hydration status at the start of exercise significantly impacts performance and thermoregulation. Starting even slightly dehydrated (2% body mass deficit) can impair endurance performance by 5-10% ([Cheuvront & Kenefick, 2014, *Comprehensive Physiology*](https://pubmed.ncbi.nlm.nih.gov/24382024/)).
...
| --- | --- | --- | --- |
| Standard workout | 300-600mg total | 2-4 hours before | [Shirreffs & Sawka, 2011](https://pubmed.ncbi.nlm.nih.gov/21916793/) |
| Hot conditions (>25°C) | 10-25 mg/kg body weight | 2-3 hours before | [Sims et al., 2007](https://pubmed.ncbi.nlm.nih.gov/17473778/) |
| Known heavy sweater | 500-1000mg total | 2-4 hours before | [Baker & Jeukendrup, 2014](https://pubmed.ncbi.nlm.nih.gov/24692140/) |
| Long race (>3 hours) | 10-20 mg/kg body weight | With pre-race meal | [McCubbin et al., 2020](https://pubmed.ncbi.nlm.nih.gov/31758487/) |
...
1. **Workout duration** → Longer sessions justify more aggressive pre-hydration
2. **Your sweat rate profile** → Heavy sweaters get higher targets
3. **Environmental conditions** → Heat/humidity triggers sodium loading protocol
4. **Sport type** → Running gets more conservative final-hour guidance
...
A systematic review on gastrointestinal distress noted that *"an estimated 30-90% of endurance athletes engaging in marathons, triathlons, and running report experiencing GI symptoms during exercise"* ([ter Steege et al., 2008](https://pubmed.ncbi.nlm.nih.gov/18586196/)).
...
| --- | --- | --- |
| **Cycling** | 80-120 g/hr | Stable platform, no impact, can eat solids ([Jeukendrup, 2011](https://pubmed.ncbi.nlm.nih.gov/22150427/)) |
| **Running** | 50-70 g/hr | GI jostling limits absorption ([Peters et al., 1999](https://pubmed.ncbi.nlm.nih.gov/10364014/)) |
| **Swimming** | Pre/post only | Can't fuel during; reduced sweat anyway ([Jeukendrup et al., 2005](https://pubmed.ncbi.nlm.nih.gov/15707377/)) |
...
Research on triathlon-specific nutrition confirms this effect: *"the change in body position among the three disciplines may impair gastric emptying and increase GI distress"* ([Jeukendrup, Jentjens & Moseley, 2005, *Sports Medicine*](https://pubmed.ncbi.nlm.nih.gov/15707377/)).
...
This massive range has been documented across multiple studies. Baker et al. (2016) analyzed 506 athletes and found sweat sodium concentrations ranging from **230 to 1,840 mg/L, with a mean of 826 mg/L** ([Baker et al., 2016, *Sports Medicine*](https://pubmed.ncbi.nlm.nih.gov/26553489/)).
...
This isn't just academic. Baker et al. (2019) demonstrated significant sport-specific differences in sodium losses, with American football and endurance athletes showing the greatest need for deliberate replacement strategies ([Baker et al., 2019, *Journal of Sports Sciences*](https://pubmed.ncbi.nlm.nih.gov/31340726/)).
...
How much should you replace? Research suggests targeting 50-80% replacement during exercise is both practical and effective. The International Society of Sports Nutrition recommends **500-700 mg of sodium per liter of fluid** for ultra-endurance events ([Tiller et al., 2019, *Journal of the International Society of Sports Nutrition*](https://pubmed.ncbi.nlm.nih.gov/31687085/)).

For hot/humid conditions (>25°C and/or >60% humidity), intake should increase to **300-600 mg sodium per hour** ([Tiller et al., 2019](https://pubmed.ncbi.nlm.nih.gov/31687085/)).
...
But here's the flip side: **don't over-drink either**. Hyponatremia (dangerously low blood sodium from drinking too much plain water) is a real risk in long events, particularly marathons and Ironman races ([Hew-Butler et al., 2015](https://pubmed.ncbi.nlm.nih.gov/26102445/)).
...
([Baker et al., 2016, *Sports Medicine*](https://pubmed.ncbi.nlm.nih.gov/26553489/))
...
| --- | --- | --- |
| Hot (>25°C / 77°F) | +25-40% | [Tiller et al., 2019](https://pubmed.ncbi.nlm.nih.gov/31687085/) |
| Humid (>70%) | +20-30% | [Sawka et al., 2007](https://pubmed.ncbi.nlm.nih.gov/17277604/) |
...
That indoor trainer adjustment is no joke — without wind cooling, sweat rates can nearly double. A German position statement on fluid replacement notes that athletes should pay particular attention to hydration during indoor training ([Mosler et al., 2020, *German Journal of Sports Medicine*](https://pubmed.ncbi.nlm.nih.gov/32587553/)).
...
1. **Replenish glycogen stores** — Restore the muscle fuel you just burned ([Burke et al., 2004](https://pubmed.ncbi.nlm.nih.gov/14971431/))
2. **Repair and build muscle** — Provide amino acids for muscle protein synthesis ([Moore et al., 2009](https://pubmed.ncbi.nlm.nih.gov/19056590/))
3. **Rehydrate** — Replace fluid and electrolytes lost through sweat ([Shirreffs et al., 1996](https://pubmed.ncbi.nlm.nih.gov/8897382/))
...
Muscle glycogen resynthesis is indeed fastest in the first 30-60 minutes post-exercise, when the enzyme glycogen synthase is most active and muscles are highly insulin-sensitive ([Ivy et al., 1988, *Journal of Applied Physiology*](https://pubmed.ncbi.nlm.nih.gov/3284871/)).
...
The rate of glycogen resynthesis maxes out at approximately **1.0-1.2 g/kg/hour** for the first 4 hours post-exercise ([Burke et al., 2004](https://pubmed.ncbi.nlm.nih.gov/14971431/)). Consuming more than this doesn't speed up the process — it just gets stored as fat or oxidized.

| Recovery Window | Carb Target | Rationale |
| --- | --- | --- |
| 0-30 min | 1.0-1.2 g/kg | Maximizes glycogen synthase activity ([Ivy, 1988](https://pubmed.ncbi.nlm.nih.gov/3284871/)) |
| 30-60 min | 1.0-1.2 g/kg | Continued rapid resynthesis |
| 2-4 hours | 1.0-1.2 g/kg/hr | If rapid recovery needed |
| 24-hour total | 5-7 g/kg (moderate) to 7-12 g/kg (high volume) | For full glycogen restoration ([Burke et al., 2011](https://pubmed.ncbi.nlm.nih.gov/21916794/)) |
...
High glycemic index (GI) carbohydrates produce faster glycogen resynthesis in the immediate post-exercise period ([Burke et al., 1993](https://pubmed.ncbi.nlm.nih.gov/8105611/)). Good choices include:
...
Research consistently shows that **20-40g of high-quality protein** (or **0.25-0.4 g/kg body weight**) maximally stimulates muscle protein synthesis post-exercise ([Moore et al., 2009](https://pubmed.ncbi.nlm.nih.gov/19056590/)).

A dose-response study found that 20g of egg protein stimulated muscle protein synthesis maximally in young men after resistance exercise, with 40g providing no additional benefit for whole-body protein synthesis ([Witard et al., 2014, *American Journal of Clinical Nutrition*](https://pubmed.ncbi.nlm.nih.gov/24257722/)).

However, for older athletes (>40) or after particularly damaging exercise (long runs, eccentric work), higher doses of **40g** may be beneficial ([Moore et al., 2015](https://pubmed.ncbi.nlm.nih.gov/24760916/)).

**Protein Quality: Leucine Is Key**

Not all proteins are equal for muscle recovery. The amino acid **leucine** is the primary trigger for muscle protein synthesis. Research suggests a leucine threshold of **2.5-3g** is needed to maximally stimulate this process ([Churchward-Venne et al., 2012](https://pubmed.ncbi.nlm.nih.gov/22952178/)).
...
*Source: [van Vliet et al., 2015, Journal of Nutrition](https://pubmed.ncbi.nlm.nih.gov/26224750/)*
...
Running creates significant eccentric muscle damage from the repetitive impact and braking forces. Research shows that marathon running causes measurable muscle damage lasting 7-14 days ([Howatson & van Someren, 2008](https://pubmed.ncbi.nlm.nih.gov/18489195/)).
...
| Anti-inflammatory foods | Encouraged | Tart cherry, omega-3s may help ([Howatson et al., 2010](https://pubmed.ncbi.nlm.nih.gov/20459662/)) |
...
- Fluid: 150% of losses ([Shirreffs et al., 1996](https://pubmed.ncbi.nlm.nih.gov/8897382/))
...
*Depletion estimates based on moderate-intensity exercise; higher intensity accelerates depletion ([Hawley & Burke, 2010](https://pubmed.ncbi.nlm.nih.gov/20616742/))*
...
Research by Shirreffs et al. (1996) established that athletes must consume **150% of fluid losses** to achieve euhydration, because some fluid is lost to urine production during the rehydration process ([Shirreffs et al., 1996, *Medicine and Science in Sports and Exercise*](https://pubmed.ncbi.nlm.nih.gov/8897382/)).
...
Plain water is poorly retained. Adding sodium (500-700 mg/L) significantly improves fluid retention post-exercise ([Maughan et al., 1994](https://pubmed.ncbi.nlm.nih.gov/8077886/)).
...
| Milk | ~500 mg/L + protein | Excellent retention ([Shirreffs et al., 2007](https://pubmed.ncbi.nlm.nih.gov/17138941/)) |

*Source: [Evans et al., 2017, European Journal of Applied Physiology](https://pubmed.ncbi.nlm.nih.gov/28213864/)*
...
Research shows that protein timing becomes *more* important during caloric restriction, as the margin for error in muscle protein balance is smaller ([Areta et al., 2014](https://pubmed.ncbi.nlm.nih.gov/24477298/)).

### Summary: Mealvana's Post-Workout Decision Tree

When generating your post-workout recommendations, Mealvana considers:

1. **When is your next workout?** → <8 hours = aggressive; >24 hours = flexible timing
...
- Sodium loss: ~330mg
- Note: Pre-race fueling carries you through ([Jeukendrup et al., 2005](https://pubmed.ncbi.nlm.nih.gov/15707377/))
...
- Base carb recommendation: 60-75 g/hr for this duration/intensity ([Burke et al., 2011](https://pubmed.ncbi.nlm.nih.gov/21916794/))
...
- Brick penalty applied: Reduce by 20% due to bike-to-run GI stress ([Jeukendrup et al., 2005](https://pubmed.ncbi.nlm.nih.gov/15707377/))
...
*Higher protein recommendation due to running-induced muscle damage ([Howatson & van Someren, 2008](https://pubmed.ncbi.nlm.nih.gov/18489195/))*

**Post-Race Rehydration:**

Apply the 150% rule ([Shirreffs et al., 1996](https://pubmed.ncbi.nlm.nih.gov/8897382/)):
...
- **Tart cherry juice:** 8-12 oz (may reduce muscle soreness) ([Howatson et al., 2010](https://pubmed.ncbi.nlm.nih.gov/20459662/))
- **Omega-3 rich foods:** Salmon, walnuts, chia seeds
- **Avoid NSAIDs:** Ibuprofen impairs gut barrier and may slow recovery ([Van Wijck et al., 2012](https://pubmed.ncbi.nlm.nih.gov/22253445/))
...
This adaptation appears to involve upregulation of intestinal transporters (SGLT1 and GLUT5), meaning your gut literally builds more "lanes" for carbohydrate absorption with training ([Jeukendrup, 2017](https://pubmed.ncbi.nlm.nih.gov/28508671/)).

As Jeukendrup summarized: *"The gut is highly adaptable and endurance athletes should incorporate nutritional training into their training plans"* ([Jeukendrup & McLaughlin, 2011, *Nestlé Nutrition Institute Workshop Series*](https://pubmed.ncbi.nlm.nih.gov/22152073/)).
...
A systematic review on gut training concluded that *"repeated exposure to high carbohydrate intake during training can impact physiological outcomes; specifically, substrate utilization"* and can help prevent GI distress ([Costa et al., 2023, *Sports Medicine*](https://pubmed.ncbi.nlm.nih.gov/36480109/)).
...
| --- | --- |
| History of GI issues | Strongest predictor (ρ = 0.32-0.51) ([Pfeiffer et al., 2012](https://pubmed.ncbi.nlm.nih.gov/21775906/)) |
| High fiber intake before workout | Increases symptoms ([Rehrer et al., 1992](https://pubmed.ncbi.nlm.nih.gov/1386594/)) |
| High fat/protein before workout | Delays gastric emptying ([Rehrer et al., 1992](https://pubmed.ncbi.nlm.nih.gov/1386594/)) |
| Concentrated carb solutions (>8%) | Increases GI distress ([de Oliveira et al., 2014](https://pubmed.ncbi.nlm.nih.gov/24619104/)) |
| NSAIDs (ibuprofen, etc.) | Compromises gut barrier ([Van Wijck et al., 2012](https://pubmed.ncbi.nlm.nih.gov/22253445/)) |
| Dehydration | Exacerbates symptoms ([Rehrer et al., 1992](https://pubmed.ncbi.nlm.nih.gov/1386594/)) |

*Source: [Wilson, 2015, International Journal of Sport Nutrition and Exercise Metabolism](https://pubmed.ncbi.nlm.nih.gov/26024352/)*
...
- **If nausea hits:** Switch to simple carbs (cola, flat ginger ale) + broth only ([Stuempfle & Hoffman, 2015](https://pubmed.ncbi.nlm.nih.gov/25811308/))
...
3. Jeukendrup AE, Jentjens RL, Moseley L. (2005). Nutritional considerations in triathlon. *Sports Medicine*, 35(2):163-181. [PubMed](https://pubmed.ncbi.nlm.nih.gov/15707377/)
4. Sareban M et al. (2016). Carbohydrate intake in form of gel is associated with increased gastrointestinal distress. *International Journal of Sport Nutrition and Exercise Metabolism*, 26(2):114-122. [PubMed](https://pubmed.ncbi.nlm.nih.gov/26402027/)

### Sweat & Sodium

1. Baker LB et al. (2016). Normative data for regional sweat sodium concentration. *Journal of Sports Sciences*, 34(4):358-368. [PubMed](https://pubmed.ncbi.nlm.nih.gov/26553489/)
...
3. Baker LB et al. (2019). Normative data for sweating rate, sweat sodium concentration, and sweat sodium loss: An update and analysis by sport. *Journal of Sports Sciences*, 37(20):2356-2366. [Taylor & Francis](https://pubmed.ncbi.nlm.nih.gov/31340726/)
...
2. Tiller NB et al. (2019). ISSN Position Stand: Nutritional considerations for single-stage ultra-marathon training and racing. *Journal of the International Society of Sports Nutrition*, 16(1):50. [PubMed](https://pubmed.ncbi.nlm.nih.gov/31687085/)
3. Cheuvront SN, Kenefick RW. (2014). Dehydration: Physiology, assessment, and performance effects. *Comprehensive Physiology*, 4(1):257-285. [PubMed](https://pubmed.ncbi.nlm.nih.gov/24382024/)
4. Sims ST et al. (2007). Pre-exercise sodium loading aids fluid balance and endurance for women exercising in the heat. *Journal of Applied Physiology*, 103(2):534-541. [PubMed](https://pubmed.ncbi.nlm.nih.gov/17473778/)
5. McCubbin AJ et al. (2020). Sodium ingestion before and during exercise in the heat: A systematic review and meta-analysis. *Sports Medicine*, 50(2):225-244. [PubMed](https://pubmed.ncbi.nlm.nih.gov/31758487/)
6. Baker LB, Jeukendrup AE. (2014). Optimal composition of fluid-replacement beverages. *Comprehensive Physiology*, 4(2):575-620. [PubMed](https://pubmed.ncbi.nlm.nih.gov/24692140/)

### Gut Training

1. Cox GR et al. (2010). Daily training with high carbohydrate availability increases exogenous carbohydrate oxidation. *Journal of Applied Physiology*, 109(1):126-134. [PubMed](https://pubmed.ncbi.nlm.nih.gov/20466802/)
2. Jeukendrup AE, McLaughlin J. (2011). Carbohydrate ingestion during exercise: effects on performance, training adaptations and trainability of the gut. *Nestlé Nutrition Institute Workshop Series*, 69:1-12. [PubMed](https://pubmed.ncbi.nlm.nih.gov/22152073/)
3. Costa RJS et al. (2023). The effect of gut-training and feeding-challenge on markers of gastrointestinal status. *Sports Medicine*. [Springer](https://pubmed.ncbi.nlm.nih.gov/36480109/)
...
8. de Oliveira EP, Burini RC. (2009). The impact of physical exercise on the gastrointestinal tract. *Current Opinion in Clinical Nutrition and Metabolic Care*, 12(5):533-538. [PubMed](https://pubmed.ncbi.nlm.nih.gov/19136507/)
9. van Wijck K et al. (2012). Exercise-induced splanchnic hypoperfusion results in gut dysfunction in healthy men. *PLoS One*, 7(1):e30724. [PubMed](https://pubmed.ncbi.nlm.nih.gov/22253445/)
10. Shirreffs SM, Sawka MN. (2011). Fluid and electrolyte needs for training, competition, and recovery. *Journal of Sports Sciences*, 29(Suppl 1):S39-S46. [PubMed](https://pubmed.ncbi.nlm.nih.gov/21916793/)

### Post-Exercise Recovery Nutrition

1. Ivy JL et al. (1988). Muscle glycogen synthesis after exercise: effect of time of carbohydrate ingestion. *Journal of Applied Physiology*, 64(4):1480-1485. [PubMed](https://pubmed.ncbi.nlm.nih.gov/3284871/)
...
3. Burke LM et al. (2004). Carbohydrates and fat for training and recovery. *Journal of Sports Sciences*, 22(1):15-30. [PubMed](https://pubmed.ncbi.nlm.nih.gov/14971431/)
4. Burke LM et al. (1993). Muscle glycogen storage after prolonged exercise: effect of the glycemic index of carbohydrate feedings. *Journal of Applied Physiology*, 75(2):1019-1023. [PubMed](https://pubmed.ncbi.nlm.nih.gov/8105611/)
...
7. Moore DR et al. (2015). Protein ingestion to stimulate myofibrillar protein synthesis requires greater relative protein intakes in healthy older versus younger men. *Journals of Gerontology Series A*, 70(1):57-62. [PubMed](https://pubmed.ncbi.nlm.nih.gov/24760916/)
...
10. Churchward-Venne TA et al. (2012). Role of protein and amino acids in promoting lean mass accretion with resistance exercise and attenuating lean mass loss during energy deficit in humans. *Amino Acids*, 45(2):231-240. [PubMed](https://pubmed.ncbi.nlm.nih.gov/22952178/)
11. van Vliet S et al. (2015). The skeletal muscle anabolic response to plant- versus animal-based protein consumption. *Journal of Nutrition*, 145(9):1981-1991. [PubMed](https://pubmed.ncbi.nlm.nih.gov/26224750/)
12. Shirreffs SM et al. (1996). Post-exercise rehydration in man: effects of volume consumed and drink sodium content. *Medicine and Science in Sports and Exercise*, 28(10):1260-1271. [PubMed](https://pubmed.ncbi.nlm.nih.gov/8897382/)
13. Shirreffs SM et al. (2007). Milk as an effective post-exercise rehydration drink. *British Journal of Nutrition*, 98(1):173-180. [PubMed](https://pubmed.ncbi.nlm.nih.gov/17138941/)
14. Maughan RJ et al. (1994). Restoration of fluid balance after exercise-induced dehydration: effects of food and fluid intake. *European Journal of Applied Physiology*, 69(3):209-215. [PubMed](https://pubmed.ncbi.nlm.nih.gov/8077886/)
15. Evans GH et al. (2017). Optimizing the restoration and maintenance of fluid balance after exercise-induced dehydration. *Journal of Applied Physiology*, 122(4):945-951. [PubMed](https://pubmed.ncbi.nlm.nih.gov/28213864/)
...
17. Howatson G et al. (2010). Influence of tart cherry juice on indices of recovery following marathon running. *Scandinavian Journal of Medicine and Science in Sports*, 20(6):843-852. [PubMed](https://pubmed.ncbi.nlm.nih.gov/20459662/)
18. Areta JL et al. (2014). Reduced resting skeletal muscle protein synthesis is rescued by resistance exercise and protein ingestion following short-term energy deficit. *American Journal of Physiology*, 306(8):E989-E997. [PubMed](https://pubmed.ncbi.nlm.nih.gov/24477298/)

### Fasted Training & Carbohydrate Periodization

1. Vieira AF et al. (2016). Effects of aerobic exercise performed in fasted v. fed state on fat and carbohydrate metabolism in adults: A systematic review and meta-analysis. *British Journal of Nutrition*, 116(7):1153-1164. [PubMed](https://pubmed.ncbi.nlm.nih.gov/27609363/)
2. Gillen JB, West DWD, Williamson EP, Fung HJW, Moore DR. (2019). Low-carbohydrate training increases protein requirements of endurance athletes. *Medicine & Science in Sports & Exercise*, 51(11):2294-2301. [PubMed](https://pubmed.ncbi.nlm.nih.gov/31107837/)
3. Marquet LA et al. (2016). Enhanced endurance performance by periodization of carbohydrate intake: "Sleep Low" strategy. *Medicine & Science in Sports & Exercise*, 48(4):663-672. [PubMed](https://pubmed.ncbi.nlm.nih.gov/26741119/)
4. Alghannam AF et al. (2020). Exercise training and fasting: Current insights. *Open Access Journal of Sports Medicine*, 11:1-28. [PubMed](https://pubmed.ncbi.nlm.nih.gov/31998064/)
5. Impey SG, Hearris MA, Hammond KM, Bartlett JD, Louis J, Close GL, Morton JP. (2018). Fuel for the work required: A theoretical framework for carbohydrate periodization and the glycogen threshold hypothesis. *Sports Medicine*, 48(5):1031-1048. [PubMed](https://pubmed.ncbi.nlm.nih.gov/29453741/)
6. Moore DR et al. (2014). Beyond muscle hypertrophy: Why dietary protein is important for endurance athletes. *Applied Physiology, Nutrition, and Metabolism*, 39(9):987-997. [PubMed](https://pubmed.ncbi.nlm.nih.gov/24835509/)
7. Rothschild JA, Kilding AE, Plews DJ. (2020). Prevalence and determinants of fasted training in endurance athletes: A survey analysis. *International Journal of Sport Nutrition and Exercise Metabolism*, 30(5):345-356. [PubMed](https://pubmed.ncbi.nlm.nih.gov/32707555/)
8. Impey SG, Hammond KM, Shepherd SO, Sharples AP, Stewart C, Limb M, Smith K, Philp A, Jeromson S, Hamilton DL, Close GL, Morton JP. (2016). Fuel for the work required: A practical approach to amalgamating train-low paradigms for endurance athletes. *Physiological Reports*, 4(10):e12803. [PubMed](https://pubmed.ncbi.nlm.nih.gov/27302770/)
9. Hearris MA, Hammond KM, Fell JM, Morton JP. (2018). Regulation of muscle glycogen metabolism during exercise: Implications for endurance performance and training adaptations. *Nutrients*, 10(3):298. [PubMed](https://pubmed.ncbi.nlm.nih.gov/29498691/)
10. Hawley JA, Morton JP. (2014). Ramping up the signal: Promoting endurance training adaptation in skeletal muscle by nutritional manipulation. *Clinical and Experimental Pharmacology and Physiology*, 41(8):608-613. [PubMed](https://pubmed.ncbi.nlm.nih.gov/24754527/)
11. Bartlett JD, Hawley JA, Morton JP. (2015). Carbohydrate availability and exercise training adaptation: Too much of a good thing? *European Journal of Sport Science*, 15(1):3-12. [PubMed](https://pubmed.ncbi.nlm.nih.gov/24942068/)
